...
import { Text, View, TouchableHighlight, TextInput, ActivityIndicator, StyleSheet, Dimensions, Button, Alert, LogBox, YellowBox } from 'react-native'
...
function SendRequest () { // useless function
  ...
  const params = [App.state.login, App.state.password]
