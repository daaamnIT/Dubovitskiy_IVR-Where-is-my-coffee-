...
-	Возможность владельцу кофейни сделать рассылку пользователям (например: "Появились новые дессерты")
-	Возможность пользователю отключать/включать уведомления
-	Возможность пользователю настроить переодичность уведомлений (например 1 раз/день или 2 раза/неделя)
